local function DumpRareToChat(rare)
	...
	if rare.EventType == "Alive" then
		print("RareShare Debug: ("..rare.SourceCharacter.." @ "..rare.SourcePublisher..") "..rare.ID.." ("..rare.Name..") alive ("..rare.Health.."% HP) at ("..rare.X..","..rare.Y..") in "..rare.Zone..flags)
	elseif rare.EventType == "Dead" then
		print("RareShare Debug: ("..rare.SourceCharacter.." @ "..rare.SourcePublisher..") "..rare.ID.." dead in "..rare.Zone..flags)
	end
end
